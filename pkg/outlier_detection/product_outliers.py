...
class ProductOutlierDetector:
    def __init__(self, rabbitmq_client: RabbitMQClient, contamination: float = 0.1):
        """
        Initialize the outlier detection model.
        
        Args:
            rabbitmq_client (RabbitMQClient): Client for RabbitMQ communication
    ...
    async def load_data(self) -> pd.DataFrame:
        """
        Retrieve and process product data from the entity management service.
        ...
        """
        products = await self.rabbitmq.request_products()
